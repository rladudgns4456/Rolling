      ...
      >
        ...
        <section className="py-8 rounded-2xl bg-indigo-50/50 md:py-10  xl:py-[60px] min-h-[324px]">
          <div className="flex flex-col justify-between h-full xl:flex-row md:gap-y-9 xl:gap-0 gap-y-12">
            ...
            <div className="relative overflow-hidden text-0 min-h-[114px]">
              <img  className="absolute max-h-full -translate-x-1/2 -translate-y-1/2 md:relative max-w-none md:max-w-full top-1/2 left-1/2 md:max-h-full md:translate-x-0 md:translate-y-0 md:top-0 md:left-0" src={point1} alt="롤링 미리보기 1" />
            </div>
          </div>
        </section>
